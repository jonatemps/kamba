			...
			<div class="agileits-services-grids">
				...
				<div class="col-md-8 agileinfo-services-right">
					...
					{{-- <div class="col-md-6 w3-agileits-services-grid ">
						<i class="fa fa-plane" aria-hidden="true"></i>
						<h4>Favoriser l'émencipation de la femme</h4>
						<p>les activités qui consiste à affranchir la femme d'un lien, d'une entrave, d'un état de dépendance, d'une domination, d'un préjugé.</p>
					</div> --}}
					<div class="clearfix"> </div>
				</div>
				<div class="clearfix"> </div>
		...
		{{-- <div class="container">
			<div class="wthree-news-grids">
				<div class="col-md-4 agileinfo-services-left agile-news-left">
					<h3>Nos <span>articles</span></h3>
					<p>Les articles de nos experts Chaque mois, notre comité de rédaction composé d'experts de différents départements vous propose une série d'articles. Confiance, Nos valeurs sont les mêmes que les vôtres.</p>
				</div>
				<div class="col-md-8 agile-news-right">
                    ...
                    <div class="col-md-6 agile-news-right-info">
						...
						<div class="col-md-6 agile-news-img-info">
							...
							<p>{{substr($post->title,0,60)}}</p>
							<h6><i class="fa fa-calendar" aria-hidden="true"></i> {{$post->formatDate()}}</h6>
						</div>
						<div class="clearfix"> </div>
					</div>
                    @endforeach
