	...
	<div class="a-grid">
		<div class="container">
			...
			<div class="w3l-about-heading">
				<h2>{{__("A propos")}} <span>{{__("de nous")}}</span></h2>
			</div>
			<div class="agileits-a-about-grids">
				...
				<div class="col-md-7 agileits-a-about-right">
					<h3>{{__("Un petit mot à propos de nous")}}</h3>
					<h4>{{__("Notre objet social est celui d'améliorer les conditions de vie des congolais par l'organisation des activités visant à leur rendre autonômes et responsables pour l'émergence de notre très cher pays le RDC sur le plan social, économique, sanitaire, culturel et autre.")}}</h4>
					<h3>{{__("La fondation à pour objectifs:")}}</h3>
                    ...
                    <ul>
                        <li><p>{{__("Elébore et exécuter des Project de développements dans plusieurs domaine d’éducation, d’agriculture, de santé et social ;")}}</p></li>
                        <li><p>{{__("La lutte contre l’insécurité alimentaire par la promotion de l’agriculture ;")}}</p></li>
                        <li><p>{{__("Créer des supers marchés à grand échelle aux normes international sur toute l’étendue de la RDC ;")}}</p></li>
                        <li><p>{{__("Combattre l’analphabétisation et tous les autres déficits dans le domaine éducatif;")}}</p></li>
                        <li><p>{{__("La lutte contre le désœuvrement et les antivaleurs flagrant parmi la jeunesse et épanouir celle-ci par tous moyens légaux de développements ;")}}</p></li>
                        {{-- <li><p>Élément</p></li>
                        <li><p>Élément</p></li> --}}
                        </ul>
				</div>
	...
	<div class="jarallax different">
		<div class="container">
			<div class="w3-different-heading">
				<h3>{{__("Pourquoi sommes-nous")}} <span>{{__("différent")}}</span></h3>
				<p>{{__("Congolais, nous considerons l'impact de nos actions dans le processus du developpement de notre pays.")}}</p>
			</div>
	...
	<div class="team">
		<div class="container">
			<div class="agileinfo-team-heading">
				<h3>{{__("Notre")}} <span>{{__("Equipe")}}</span></h3>
			</div>
