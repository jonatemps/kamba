		...
		<div class="container">
			...
			<div class="agileits-a-about-grids">
				...
				<div class="col-md-7 agileits-a-about-right">
					...
					<h4>Notre objet social est celui d'améliorer les conditions de vie des congolais par l'organisation des activités visant à leur rendre autonômes et responsables pour l'émergence de notre très cher pays le RDC sur le plan social, économique, sanitaire, culturel et autre.</h4>
					<h3>La fondation à pour objectifs:</h3>
                    ...
                    <ul>
                        <li><p>Elébore et exécuter des Project de développements dans plusieurs domaine d’éducation, d’agriculture, de santé et social ;</p></li>
                        <li><p>La lutte contre l’insécurité alimentaire par la promotion de l’agriculture ;</p></li>
                        <li><p>Créer des supers marchés à grand échelle aux normes international sur toute l’étendue de la RDC ;</p></li>
                        <li><p>Combattre l’analphabétisation et tous les autres déficits dans le domaine éducatif;</p></li>
                        <li><p>La lutte contre le désœuvrement et les antivaleurs flagrant parmi la jeunesse et épanouir celle-ci par tous moyens légaux de développements ;</p></li>
                        {{-- <li><p>Élément</p></li>
                        <li><p>Élément</p></li> --}}
                        </ul>
				</div>
	...
	<div class="jarallax different">
		<div class="container">
			<div class="w3-different-heading">
				...
				<p>Congolais, nous considerons l'impact de nos actions dans le processus du developpement de notre pays.</p>
			</div>
